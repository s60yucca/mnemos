...
Use the template in [templates/claude/SYSTEM_PROMPT.md](/Users/thohd/Dev/mnemos/templates/claude/SYSTEM_PROMPT.md).
...
Use the template in [templates/kiro/steering/mnemos.md](/Users/thohd/Dev/mnemos/templates/kiro/steering/mnemos.md).
